var pixGrid = function() {
    ...
    myNode.addEventListener("click", function(e) {
        ...
        if ("IMG" === e.target.tagName) {
            ...
            myOverlay.style.top = 0, myOverlay.style.backgroundColor = "rgba(0,0,0,0.7)", 

            myOverlay.style.cursor = "pointer", 

            myOverlay.style.width = window.innerWidth + "px", myOverlay.style.height = 

            window.innerHeight + "px", 

            myOverlay.style.top = window.pageYOffset + "px", myOverlay.style.left = 
            ...
            largeImage.style.display = "block", largeImage.style.position = "absolute", 
            ...
            largeImage.addEventListener("load", function() {
                ...
                window.addEventListener("scroll", function() {
                    ...
                    myOverlay && (myOverlay.style.top = window.pageYOffset + "px", 
                ...
                window.addEventListener("resize", function() {
                    ...
                    myOverlay && (myOverlay.style.width = window.innerWidth + "px", 
